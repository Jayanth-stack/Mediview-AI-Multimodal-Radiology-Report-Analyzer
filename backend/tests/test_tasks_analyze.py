...
from app.schemas.entities import AnalysisResponse, Finding as AnalysisFinding
...
class _FakeGemini:
    ...
    def analyze_bytes(self, **kwargs):
        ...
        return AnalysisResponse(
            ...
            findings=[
                AnalysisFinding(label="left basilar opacity", confidence=0.91),
            ],
        )
...
class AnalyzeTaskTests(unittest.TestCase):
    ...
    def test_analyze_task_success_path_persists_results(self):
        ...
        try:
            ...
            self.assertEqual(job.result["findings"][0]["label"], "left basilar opacity")
